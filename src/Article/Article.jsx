  ...
  return (
    <html lang="en">
      ...
      <div>
        ...
        <i>by Kate Farley (<u style={{ color: "Dodgerblue" }}>kate.farley@nytimes.com</u>)  </i>
        <br></br>
          November 22, 2018
        ...
        <p style={{ margin: 40 }}>Give me your tired, your poor <br></br> Your huddled masses yearning to breathe free.</p>
